...
class AuthPageLocators:
    ...
    AUTH_USER_EMAIL_INPUT = (By.XPATH, "//input[@type='text']")
    AUTH_USER_PASSWORD_INPUT = (By.XPATH, "//input[@type='password']")
    AUTH_USER_PHONE_INPUT = (By.XPATH, "//input[@type='text']")
    ...
    AUTH_USER_LOGIN_INPUT = (By.XPATH, "//div[@id='t-btn-tab-login']")
    AUTH_USER_PERSONAL_INPUT = (By.XPATH, "//div[@id='t-btn-tab-ls']")
    ...
    AUTH_SOCIAL_OD_LINK = (By.XPATH, "//a[@id='oidc_ok']")
